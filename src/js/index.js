...
// lsita para guardar imagenes o ejemplos agregados
let images = {};
let labels = {};
// los dos seran objetos iterables
let count = 0;

// numero de gestos o labels, son 8 incluyendo el no entrenado
number_labels = 8;
...
async function addExample(classId) {
  ...
  // agregamos el ejemplo a la lista
  images[count] = activation;
  labels[count] = classId;
  count++; 
